# GRG Wegkenmerken Verkeersborden Project

## Working Directory
- **Primary codebase**: `traffic-sign-frontend/`
- **ALL git operations** must be executed from `/Users/daniel/Developer/GRG-Wegkenmerken-verkeersborden/traffic-sign-frontend`
- The root folder (`/Users/daniel/Developer/GRG-Wegkenmerken-verkeersborden`) is NOT a git repository
- When creating branches, committing, pushing, or any git operations: always work in `traffic-sign-frontend/`

## Project Structure
- This is a monorepo containing frontend, multiple backends, and design system
- **Frontend**: `/traffic-sign-frontend/` - The only project we edit
- **Backend projects**: Multiple backend services (traffic-sign-backend, traffic-sign-area-backend, traffic-sign-wkd-backend, etc.)
...
- **Design system**: `/ndw-design/`
  ...
  - We always use the GRG design system for the frontend project
  - Used as reference only for components and styling
  - NEVER edit design system code

## Working Directory Rules
- ALL edits must be in `/traffic-sign-frontend/` only
...
- Use the GRG design system from `/ndw-design/` for UI components
...
- Project does not use translation/i18n strings
